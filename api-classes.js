...
class StoryList {
   ...
   */
	...
	async addStory(user, newStory) {
		...
		let storyObj = res.data.story;
		newStory = new Story(storyObj);
...
class User {
   ...
   */
	...
	removeFavorite(storyId) {
		return this.favListToggle(storyId, 'DELETE');
	}
	addFavorite(storyId) {
		return this.favListToggle(storyId, 'POST');
		console.log(this.favorites);
	}

	async favListToggle(storyId, reqverb) {
		await axios({
			method : reqverb,
